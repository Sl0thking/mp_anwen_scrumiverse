...
public class UserController extends MetaController{
	...
	/**
	 * Shows login site and prepares form object
	 ...
	 * @param formLoginUser the User-object that is generated by a springmvc form
	 * @param session the current Session
	 * @return ModelAndView
	 */
	...
	public ModelAndView checkLogin(User formLoginUser, HttpSession session) {
		...
		try {
			...
			return new ModelAndView("redirect:projectOverview.htm");
		//No User with given email address, wrong password or fatal algorithm exceptions
	 ...
	 * @param formRegUser a new User-object that is generated by a springmvc form
	...
	/**
	 * Handles a logout and invalidates the session
	 * @param session the current session
	 * @return ModelAndView
	 */
	 ...
	 * @param session the current session
	 * @param newUserData the new User-object that shall be saved
	 * @param result result of the binding
	 * @return ModelAndView
	 */
	...
	/**
	 * Handles the change of a users avatar/user-picture
	 * @param request the request
	 * @param session the current session
	 * @param file the new avatar/user-picture as a file
	 * @return ModelAndView
	 */
	...
	public ModelAndView changeUserPic(HttpServletRequest request, HttpSession session, @RequestParam("image") MultipartFile file) {
		try {
			...
			String serverPath = "resources" + File.separator + "userPictures" + File.separator + "userPic_";
	 ...
	 * @param formLoginUser the User-object that is generated by a springmvc form
	 * @param loadedUser the User-object that gets loaded from the database
	 ...
	 * @param formRegUser the user which contains the email
	 * @return a boolean that represents whether the email is still available
